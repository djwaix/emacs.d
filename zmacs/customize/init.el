...
(custom-set-variables
 ...
 '(org2blog/wp-blog-alist
	(quote
	 (("wordpress" :url "http://prodigalscribe.wordpress.com/xmlrpc.php" :username "thadeej" :password "D9EaG8wGjl"))))
 '(package-archives
	(quote
 ...
 '(package-selected-packages
	(quote
	 (circe-notifications circe powerline oauth markdown-mode htmlize fountain-mode)))
